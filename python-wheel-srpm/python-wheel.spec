...
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Daniel Holth <dholth@fastmail.fm>
...
%{python_sitelib}/*
%doc CHANGES.txt LICENSE.txt README.txt entry_points.txt
#%doc build/*

%changelog
* Mon Nov 16 2015 Nico Kadel-Garcia <nkadel@skyhookireless.com> - 0.26.0-0.1
